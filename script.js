    ...
    onValue(topRankQuery, (snapshot) => {
        ...
        if (data) {
          ...
          usersArr.forEach((user, index) => {
                ...
                // --- 🛡️ PISAHKAN TEKS PANGKAT DAN IKON SVG ---
                let rankText = '';
                let rankIconSvg = '';
                ...
                if (rankPosition <= 3) {
                    // Top 3: Teks pangkat di atas, Ikon SVG nempel di kiri Username + SUNTIKAN FONT BERLIN
                    row.innerHTML = `
                    ...
                    // Rank 4 - 17: Format Angka Pagar Standar Standar (#4, #5, dst)
                    row.innerHTML = `
